...
public:
    void reg_data() {
        ...
        cin >> password;
        fstream Enter("database.txt", ios::app);
...
public:
   ...
   void customer_data() {
       ...
       ent << "day " << day << "  month" << mon << " year" << year << endl;
   ...
   void display(){
       fstream read("name.txt");
       while (read>>name) {
               if (n == name) {
                   system("cls");
                   cout << "\t\t\t\t     ________________Car Rental Customer Invoice_______" << endl << endl;
                   cout << "\t\t\t\t\t //////////////////////////////////////////////////////" << endl;
